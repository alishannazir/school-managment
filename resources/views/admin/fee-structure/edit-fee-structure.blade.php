                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <select name="academic_year_id" class="form-control">
                                                ...
                                                @foreach ($academic_years as $academic_year)
                                                    <option value="{{ $academic_year->id }}"{{ $fee->academic_year_id == $academic_year->id ? 'selected' :null}}>{{ $academic_year->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <select name="fee_head_id" class="form-control">
                                                ...
                                                @foreach ($fee_heads as $fee_head)
                                                    <option value="{{ $fee_head->id }}"{{ $fee->fee_head_id == $fee_head->id ? 'selected' :null}}>{{ $fee_head->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                            @error('fee_head_id')
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" class="form-control" name="july"
                                                id="exampleInputEmail1" placeholder="Enter July Fee" value="{{old('july',$fee->april)}}">
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" class="form-control" name="febuary"
                                                id="exampleInputEmail1" placeholder="Enter Febuary Fee" value="{{old('febuary',$fee->febuary)}}">
                                        </div>
                                        <div class="form-group col-md-4">
